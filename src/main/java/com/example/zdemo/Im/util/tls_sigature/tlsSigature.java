package com.example.zdemo.Im.util.tls_sigature;

import com.alibaba.fastjson.JSONException;
import com.alibaba.fastjson.JSONObject;
import com.example.zdemo.Im.util.base64_url.base64_url;
...
public class tlsSigature {
	...
	public static void main(String[] args) {
		try{			
            ...
            // generate signature
            GenTLSSignatureResult result = GenTLSSignatureEx(1400000955, "xiaojun", privStr,Integer.MAX_VALUE);
